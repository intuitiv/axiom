...
class AxiomVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by AxiomParser#import_statement.
    def visitImport_statement(self, ctx:AxiomParser.Import_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AxiomParser#import_key.
    ...
    # Visit a parse tree produced by AxiomParser#assert_block.
    def visitAssert_block(self, ctx:AxiomParser.Assert_blockContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AxiomParser#assert_item.
    ...
    # Visit a parse tree produced by AxiomParser#json_object.
    def visitJson_object(self, ctx:AxiomParser.Json_objectContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by AxiomParser#json_pair.
